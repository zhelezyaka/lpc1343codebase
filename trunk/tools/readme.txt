...
===============================================================================
  imgconv
  -----------------------------------------------------------------------------
  This Windows=based application converts PNG, JPG or BMP images to an RGB565
  binary format that is understood by the LPC1343 Code Base. Using this
  utility, you can create bitmap images of different sizes and load them
  directly from an SD card reader.
  ...
  The source and project files for Visual Studio 2010 are included in /src
===============================================================================
